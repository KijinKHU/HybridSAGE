...
class NeighborSampler(object):
    def __init__(self, g, user_type, item_type, random_walk_length, random_walk_restart_prob,
        ...
        self.item_to_user_etype = list(g.metagraph()[item_type][user_type])[0]
        self.samplers = [
            RandomSampler.RandomSampler(g, random_walk_length, random_walk_restart_prob, num_random_walks, num_neighbors,
                                        [self.item_to_user_etype, self.user_to_item_etype]),
            dgl.sampling.PinSAGESampler(g, item_type, user_type, random_walk_length, random_walk_restart_prob,
